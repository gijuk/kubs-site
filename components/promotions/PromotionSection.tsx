...
export default async function PromotionSection() {
  ...
  return (
    <section
      id="promotions"
      className="relative overflow-hidden border-t border-ivory-line bg-ivory py-24"
    >
      <GlassShape
        variant="circle"
        size={180}
        className="-right-14 bottom-0 hidden md:block"
      />
      <GlassShape
        variant="hex"
        size={100}
      ...
      <div className="relative z-10 mx-auto mt-10 max-w-editorial px-6 md:px-10">
