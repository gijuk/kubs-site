...
export default function KubsHistoryGameSection() {
  return (
    <section className="relative overflow-hidden border-t border-ivory-line bg-ink-fixed px-6 py-24 md:px-10">
      <GlassShape
        tone="white"
        variant="blob"
        size={220}
      ...
      <div className="relative z-10 mx-auto flex max-w-editorial flex-col items-center gap-6 text-center">
        <div className="reveal flex flex-col items-center gap-6">
          ...
          <h2 className="font-serif text-3xl font-semibold text-ivory-fixed md:text-4xl">
            KUBS History Game
          </h2>
          <p className="max-w-[46ch] text-sm leading-relaxed text-ivory-fixed/60">
